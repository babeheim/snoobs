...
days.max = 365*100 # stop after this time (300 years in original paper)
census.census.length <- 365*5 # number of days until we do another census
ini.snoob.frq <- 0.2
ini.pop.size <- 300 # 1000 in the original paper
...
write.csv(my.data, "raw_data.csv", row.names=FALSE)
